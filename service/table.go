...
relay_binlog_name varchar(255) COMMENT '拉取上游 binlog 起始文件名',
...
skip_utf8_check int COMMENT '目标数据库 tidb_skip_utf8_check',
constraint_check_in_place int COMMENT '目标数据库 tidb_constraint_check_in_place',
...
task_source_id varchar(1024) COMMENT '源库实例名,格式 source1;source2 格式 source1;source2 格式 source1;source2 多个 source 分号分割',
create_time datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
update_time datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
do_dbs varchar(125) COMMENT '匹配的上游数据库库名迁移',
